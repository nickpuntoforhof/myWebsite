...
<div style="width:40%; height:40%; font-size:80%; float:left; padding-right:0.5em;"><img src="/img/big_pharma.jpg" alt="The Pill Man" width="width" height="height" style="padding-bottom:10em;" />The pharmaceutical industry: Influencing doctors to perscribe expensive medications in lieu of affortable equivalents?  IDK!</div>
