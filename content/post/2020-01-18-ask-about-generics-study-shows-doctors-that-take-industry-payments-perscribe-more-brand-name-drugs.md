...
<div style="width:30%; height:30%; font-size:80%; float:left;"><img src="/img/big_pharma.jpg" alt="The Pill Man" width="width" height="height" style="padding-bottom:0.5em; padding-right:100em;" />The pharmaceutical industry: Influencing doctors to perscribe expensive medications in lieu of affortable equivalents?  IDK!</div>
